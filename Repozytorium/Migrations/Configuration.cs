...
//    internal sealed class Configuration : DbMigrationsConfiguration<OGL.Models.OglContext>
//    {
...
//            {
//                var user = new Uzytkownik { UserName = "marek@ogl.pl" };
...
//            {
//                var user = new Uzytkownik { UserName = "prezes@ogl.pl" };
//                var adminresult = manager.Create(user, "1234Abc,");
//                if (adminresult.Succeeded)
//                    manager.AddToRole(user.Id, "Admin");
...
//                    Tresc = "Treœæ ogloszenia" + i.ToString(),
//                    Tytul = "Tytu³ ogloszenia" + i.ToString(),
...
//                {
//                    Id = i,
//                    Nazwa = "Nazwa kategori" + i.ToString(),
//                    Tresc = "Treœæ ogloszenia" + i.ToString(),
//                    MetaTytul = "Tytul kategorii" + i.ToString(),
//                    MetaOpis = "Opis kategorii" + i.ToString(),
//                    MetaSlowa = "slowa kluczowe" + i.ToString(),
//                    ParentId = i
//                };
