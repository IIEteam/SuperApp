    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.Error ? "Jakiś błąd."
                : message == ManageMessageId.AddPhoneSuccess ? "Twój nr telefonu został dodany."
                : message == ManageMessageId.RemovePhoneSuccess ? "Usunięty."
                : "";
